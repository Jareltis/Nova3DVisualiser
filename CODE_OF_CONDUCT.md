...
project maintainer (**Jareltis**) via GitHub. For a private channel, use this repository's
**Security → "Report a vulnerability"** form, which delivers a private report to the
